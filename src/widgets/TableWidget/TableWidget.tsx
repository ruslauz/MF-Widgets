...
type Props = { id: string; innerRef: ForwardedRef<HTMLTableElement> };

const Demo = ({ id, innerRef }: Props) => {
            ...
            <Table.Head>
              <Table.Row>
                ...
                {Object.keys(data[0])
                  .slice(1)
                  .map((name, index) => (
                    <Table.CellHead key={index} width="200" align="right">
                      <Tooltip title="Lorem ipsum">
                        <span>
                          {name.toUpperCase()}{" "}
